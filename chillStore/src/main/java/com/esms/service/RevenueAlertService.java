...
//        BigDecimal currentRevenue = getRevenueBetween(currentMonthStart, currentPeriodEnd);
//        BigDecimal previousRevenue = getRevenueBetween(previousPeriodStart, previousPeriodEnd);
//
...
//
//        BigDecimal currentRevenue = getRevenueBetween(currentPeriodStart, currentPeriodEnd);
//        BigDecimal previousRevenue = getRevenueBetween(previousPeriodStart, previousPeriodEnd);
//
//        if (currentRevenue > 0 && previousRevenue >0) {
//           double change = (currentRevenue - previousRevenue) / previousRevenue;
...
//    }
//
//    private BigDecimal getRevenueBetween(LocalDate start, LocalDate end) {
